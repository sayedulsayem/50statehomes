...
<div class="register-box">
    ...
    <div class="register-box-body">
        ...
        <form action="{{ url('/admin/registration') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group has-feedback">
                <input name="c_password" type="password" class="form-control" placeholder="Retype password">
            ...
            <div class="form-group has-feedback">
                ...
                <span class="form-control-feedback fa fa-image"></span>
            </div>
            <div class="row">
                <div class="col-xs-8">
        ...
        <a href="{{ url('/admin/login') }}" class="text-center btn btn-primary btn-block btn-flat">I already have a membership</a>
    </div>
    <!-- /.form-box -->
</div>
<!-- /.register-box -->
