...
<div class="wrapper">
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{ asset(Session::get('image')) }}" class="user-image" alt="User Image">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{ url('/admin/profile/edit/'.session::get('id')) }}" class="btn btn-default btn-flat">Profile</a>
                                </div>
                                <div class="pull-right">
                                    <a href="{{ url('/log-out') }}" class="btn btn-default btn-flat">Sign out</a>
                                </div>
                            </li>
                        </ul>
                    </li>
    ...
    @extends('admin-panel.left-side-bar')
    ...
    <footer class="main-footer">
        ...
        <strong>Developed by <a href="https://swiftcodeit.com/" target="_blank">Swift Code IT</a>.</strong>
    </footer>
...
<!-- ChartJS -->
<script src="{{ asset('panel') }}/bower_components/chart.js/Chart.js"></script>
