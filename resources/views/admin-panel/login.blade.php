...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form action="{{ url('/admin/login-verify') }}" method="post">
            @csrf
        ...
        <a href="#" class="text-center btn btn-primary btn-block btn-flat">I forgot my password</a><br>
        <a href="{{ url('/admin/register') }}" class="text-center btn btn-primary btn-block btn-flat">Register a new membership</a>
